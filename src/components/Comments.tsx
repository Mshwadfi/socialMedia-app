  ...
  return (
    <div className="">
      <div className="flex items-center gap-5">
        <Image alt="" src={'https://images.pexels.com/photos/21550548/pexels-photo-21550548/free-photo-of-waves-of-a-sea-hitting-rocks.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load'} width={32} height={32} className="w-8 h-8 rounded-full"/>
